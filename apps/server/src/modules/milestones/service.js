...
import { CONTRACT_PAYMENT_TYPES, ESCROW_STATUSES, HTTP_STATUS, MILESTONE_STATUSES, CONTRACT_STATUSES, WORK_STATUS } from "../../shared/config/constants.js";
...
export class MilestoneService {
  ...
  async updateWorkStatus(milestoneId, userId, workStatus, options = {}) {
    ...
    if (
      workStatus === WORK_STATUS.IN_PROGRESS &&
      !isRevisionStart &&
      ![ESCROW_STATUSES.FUNDED, ESCROW_STATUSES.IN_PROGRESS].includes(contract.escrowStatus)
    ) {
