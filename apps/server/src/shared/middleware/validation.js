...
function validateData(data, rules) {
  ...
  for (const rule of rules) {
    ...
    // Special handling for numeric fields - accept both number and numeric string
    if ((rule.field === "amount" || rule.field === "proposedRate") && (actualType === "string" || actualType === "number")) {
